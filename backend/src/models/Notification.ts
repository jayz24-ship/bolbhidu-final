...
export interface INotification {
  ...
  title: string;
  message: string;
  data?: any; // Additional data (postId, issueId, etc.)
  isRead: boolean;
  createdAt: Date;
  updatedAt: Date;
}
...
export const Notification = mongoose.model<INotificationDoc, INotificationModel>('Notification', NotificationSchema);
